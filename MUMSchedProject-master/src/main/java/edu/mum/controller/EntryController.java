...
public class EntryController {
	...
	public String saveEntry(@ModelAttribute("entry") Entry newEntry){
		
		entryService.saveEntry(newEntry);
		
		return "redirect:/admin/allEntry";
	}
	...
	public String updateEntry(@RequestParam String id, @RequestParam String entryMonth, @RequestParam int numOfMpp, 
